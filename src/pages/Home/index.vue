<template>
  <div class="bgc">
    ...
    <div v-if="initFlag">
      ...
      <!-- 底部版权信息 -->
      <div class="copyR">
        <div @click="gotoCopyRight()" style="cursor: pointer;">粤ICP备2022107861号</div>
        <div style="cursor: pointer;" @click="gotoCopyRight()">粤ICP备2022107861号-1</div>
    ...
    <div v-if="afloginFlag">
      ...
      <!-- 底部版权信息 -->
      <div class="copyR">
        <div @click="gotoCopyRight()" style="cursor: pointer;">粤ICP备2021079778号</div>
        <div style="cursor: pointer;" @click="gotoCopyRight()">粤ICP备2021079778号-1</div>
        <div>@CopyRight STU-ACM</div>
      </div>
    </div>
